...
run_cpp: compiler
	...
	g++ output.cpp -o program_cpp
	./program_cpp

run_asm: compiler
	./compiler valid/test1.cpm
	g++ output.s -o program_asm -lm
	./program_asm
...
clean:
		rm -f parser.tab.* lex.yy.c* compiler stack.hh position.hh location.hh tree.dot tree.pdf tree_semantic.dot tree_semantic.pdf symtable.dot symtable.pdf cfg.dot cfg.pdf output.cpp program_cpp program_asm output.s
		rm -R compiler.dSYM 
