compiler: lex.yy.c parser.tab.o main.cc IRGenerator.cc
		g++ -g -w -ocompiler parser.tab.o lex.yy.c main.cc IRGenerator.cc -std=c++14
...
clean:
		rm -f parser.tab.* lex.yy.c* compiler stack.hh position.hh location.hh tree.dot tree.pdf tree_semantic.dot tree_semantic.pdf symtable.dot symtable.pdf cfg.dot cfg.pdf
		rm -R compiler.dSYM 
